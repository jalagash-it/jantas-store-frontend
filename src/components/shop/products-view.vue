<template>
  ...
  >
    ...
    <div v-if="productsList.items.length === 0" class="products-view__empty">
      <div class="products-view__empty-title">Нет подходящих товаров</div>
      <div class="products-view__empty-subtitle">Попробуйте сбросить фильтры</div>
      <button
        type="button"
      ...
      <div class="products-view__options">
        ...
        >
          ...
          <div class="view-options__legend">
            Отображение {{ productsList.from }}—{{ productsList.to }} из
            {{ productsList.total }}продукты
          </div>
          <div class="view-options__divider" />
          <div class="view-options__control">
            <label for="view-options-sort"> Сортировать по</label>
            <div>
              <select
          ...
          <div class="view-options__control">
            <label for="view-options-limit"> Показать</label>
            <div>
              <select
